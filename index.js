...
//     <p><bold>Temperament:</bold> ${breedInfo.temperament}</p>
//     <p><bold>Description:</bold> ${breedInfo.description}</p>
//     <p><bold>Origin:</bold> ${breedInfo.origin}</p>
//   `;

//     Carousel.clear();

//     if (breedInfo.images && Array.isArray(breedInfo.images)) {
//       breedInfo.images.forEach((image, index) => {
